...
-- 비회원 게시글 데이터 입력
insert into app_board(bno,title,cont,pwd) values(1,'제목101','내용',sha2('1111',256));
insert into app_board(bno,title,cont,pwd) values(2,'제목102','내용',sha2('1111',256));
insert into app_board(bno,title,cont,pwd) values(3,'제목103','내용',sha2('',256));
insert into app_board(bno,title,cont,pwd) values(4,'제목104','내용',sha2('',256));
