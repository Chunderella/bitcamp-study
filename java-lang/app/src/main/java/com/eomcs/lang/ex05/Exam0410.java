...
public class Exam0410 {
  public static void main(String[] args) {
    ...
    //      [00000000000000000000000000010000] = 16  2^4

    i = 11; // [00000000000000000000000000001011]
    System.out.println(i << 1); //   0[00000000000000000000000000010110] => 22 = 11*2^1
    System.out.println(i << 2); //  00[00000000000000000000000000101100] => 44 = 11*2^2
    System.out.println(i << 3); // 000[00000000000000000000000001011000] => 88 = 11*2^3
