...
public class Exam0150 {
  ...
  public static void main(String[] args) {
    ...
    //멤버의 인스턴스가 다르면 hashcode도 다르다.
    //오버라이딩하지 않으면 object의 hashcode를 호출한다.
    ...
    System.out.printf("%b\n", m1.equals(m2)); // false //원래 오브젝트로부터 상속받은 이퀄스를 호출(주소를 호출한다)
    ...
    System.out.printf("%x, %x\n", s1.hashCode(), s2.hashCode()); //스트링 클래스에서 자체적으로 재정의한 메소드를 호출하기때문에 값이 같음.
